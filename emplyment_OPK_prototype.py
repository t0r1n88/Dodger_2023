...
opk_finish_df.to_excel(f'{path_to_end_folder}/Трудоустройство по специальностям (ОПК) от {current_time}.xlsx', index=False)
...
with pd.ExcelWriter(f'{path_to_end_folder}/Итоги по ОПК,целевикам и всем колонкам {current_time}.xlsx',engine='openpyxl') as writer:
