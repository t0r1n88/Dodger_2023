...
def processing_data_employment():
    ...
    try:
        ...
        messagebox.showerror('Кассандра Подсчет данных по трудоустройству выпускников ver 3.3',
...
def processing_diffrence():
    ...
    #                          'Возникла ошибка!!! Подробности ошибки в файле error.log')
        ...
        messagebox.showinfo('Кассандра Подсчет данных по трудоустройству выпускников ver 3.3', 'Таблицы успешно обработаны')
