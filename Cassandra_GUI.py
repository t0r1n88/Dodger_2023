...
def processing_data_employment():
    ...
    try:
        ...
        messagebox.showerror('Кассандра Подсчет данных по трудоустройству выпускников ver 3.0',
    ...
    #                          f'Проверьте файл на соответсвие шаблону')
        ...
        if error_df.shape[0] != 0:
            ...
            messagebox.showinfo('Кассандра Подсчет данных по трудоустройству выпускников ver 3.0',
...
def processing_diffrence():
    ...
    #                          'Возникла ошибка!!! Подробности ошибки в файле error.log')
        ...
        messagebox.showinfo('Кассандра Подсчет данных по трудоустройству выпускников ver 3.0', 'Таблицы успешно обработаны')
...
if __name__ == '__main__':
    window = Tk()
    window.title('Кассандра Подсчет данных по трудоустройству выпускников ver 3.0')
